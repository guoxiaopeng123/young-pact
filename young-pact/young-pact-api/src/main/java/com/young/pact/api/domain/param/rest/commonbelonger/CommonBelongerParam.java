package com.young.pact.api.domain.param.rest.commonbelonger;

import java.io.Serializable;
/**
 * 
* @ClassName: CommonBelongerParam
* @Description: TODO( 合同责任人)
* @author HeZeMin
* @date 2018年8月5日 下午3:32:37
*
 */
public class CommonBelongerParam implements Serializable {
