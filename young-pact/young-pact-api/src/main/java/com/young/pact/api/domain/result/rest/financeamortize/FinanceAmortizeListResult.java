package com.young.pact.api.domain.result.rest.financeamortize;
...
*
 */
public class FinanceAmortizeListResult implements Serializable {
    ...
    public FinanceAmortizeListResult() {
    }
