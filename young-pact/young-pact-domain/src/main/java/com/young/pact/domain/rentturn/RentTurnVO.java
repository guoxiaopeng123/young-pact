 ...
 * @描述 : 转租协议
 * @author : GuoXiaoPeng
 * @创建时间 : 2018年8月6日 下午8:46:46
 */
@SuppressWarnings("serial")
public class RentTurnVO extends BaseDomain{
    ...
    /*** @Fields settledAmount: 结算金额 */
    private Double settledAmount;
    /*** @Fields settledWay: 结算方式 */
    ...
    /*** @Fields tel: 手机号 */
    private String tel;
    /*** @Fields reletReason: 转租原因 */
    private String reletReason;
    /*** @Fields remark: 其他约定 */
    private String remark;
    /*** @Fields reletTime: 转租时间 */
    ...
    public String getReletReason() {
        return reletReason;
    }
    public void setReletReason(String reletReason) {
        this.reletReason = reletReason;
    }
    ...
    public void setReletTime(Date reletTime) {
