 ...
 * @描述 : 
 * @author : GuoXiaoPeng
 * @创建时间 : 2018年8月1日 上午11:29:17
 */
public class RentBaseVO extends BaseDomain{
    ...
    */
    ...
    /*** @Fields paperPactCode:纸质合同编号*/
    private String paperPactCode;
    /*** @Fields startTime:合同开始时间*/
    private Date startTime;
    /*** @Fields endTime:合同结束时间*/
    ...
    /*** @Fields state:合同状态 1草稿状态 2待审核 3已通过 4已驳回*/
    private Integer state;
    /*** @Fields dueState:合同到期状态 1未到期  2到期*/
    private Integer dueState;
    /*** @Fields dealState:合同成交属性1新签 2续签*/
    private Integer dealState;
    /*** @Fields cancelState:合同解约状态1未解约 2到期解约  3违约解约 4调房解约 5转租解约*/
    private Integer cancelState;
    /*** @Fields isDelete:删除状态0 未删除 1 删除*/
    private Integer isDelete;
    /*** @Fields isEffective:是否生效 0已生效(默认)，1未生效(有转，调，续，解 协议时为1)*/
