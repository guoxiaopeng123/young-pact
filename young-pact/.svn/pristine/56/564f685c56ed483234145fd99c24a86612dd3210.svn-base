package com.young.pact.api.domain.result.rest.commonbelonger;

import java.io.Serializable;
/**
 * 
* @ClassName: CommonBelongerResult
* @Description: TODO( 合同责任人)
* @author HeZeMin
* @date 2018年8月4日 下午5:46:09
*
 */
public class CommonBelongerResult implements Serializable {
