package com.young.pact.api.domain.param.rest.purchasebase;

import java.io.Serializable;
import java.util.Date;
/**
 * 
* @ClassName: PurchaseBaseQueryParam
* @Description: TODO( 合同信息)
* @author HeZeMin
* @date 2018年8月2日 上午10:21:30
*
 */
public class PurchaseBaseQueryParam implements Serializable {
    ...
    /*** @Fields entrustEndMin:到期时间最小*/
    private String entrustEndMin;
    /*** @Fields entrustEndMax:到期时间最大*/
    private String entrustEndMax;
    /*** @Fields operatingPin:运营管家*/
    private String operatingPin;
    /*** @Fields servicePin:租后管家*/
    ...
    public String getEntrustEndMin() {
        return entrustEndMin;
    }



    public void setEntrustEndMin(String entrustEndMin) {
        this.entrustEndMin = entrustEndMin;
    }



    public String getEntrustEndMax() {
        return entrustEndMax;
    }



    public void setEntrustEndMax(String entrustEndMax) {
        this.entrustEndMax = entrustEndMax;
    }



    public String getOperatingPin() {
        return operatingPin;
    }



    public void setOperatingPin(String operatingPin) {
        this.operatingPin = operatingPin;
    }
