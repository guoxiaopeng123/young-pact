...
/**
 * 
* @ClassName: FinanceReceiptPayParam
* @Description: TODO( 收支)
* @author HeZeMin
* @date 2018年8月2日 上午10:29:12
*
 */
public class FinanceReceiptPayParam implements Serializable {
    ...
    private List<FinanceReceiptPayVoucherParam> financeReceiptPayVoucherList;
    
    public FinanceReceiptPayParam() {
    }
    ...
    public List<FinanceReceiptPayVoucherParam> getFinanceReceiptPayVoucherList() {
        return financeReceiptPayVoucherList;
    }
    public void setFinanceReceiptPayVoucherList(List<FinanceReceiptPayVoucherParam> financeReceiptPayVoucherList) {
