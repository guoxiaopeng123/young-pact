package com.young.pact.api.domain.result.rest.declare;
...
public class DeclareResult implements Serializable{
    ...
    */
    ...
    /*** @Fields declarePriceParams:申报价格集合*/
    private List<DeclarePriceResult> declarePriceResults;
    /*** @Fields create:创建时间*/
    private Date create;
    ...
    public List<DeclarePriceResult> getDeclarePriceResults() {
        return declarePriceResults;
    }
    public void setDeclarePriceResults(List<DeclarePriceResult> declarePriceResults) {
        this.declarePriceResults = declarePriceResults;
    }
