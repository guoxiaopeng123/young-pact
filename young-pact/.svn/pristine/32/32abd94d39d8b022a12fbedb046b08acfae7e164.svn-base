package com.young.pact.api.domain.param.rest.purchasehouse;

import java.io.Serializable;
/**
 * 
* @ClassName: PurchaseHouseParam
* @Description: TODO( 托进合同房源信息)
* @author HeZeMin
* @date 2018年8月1日 上午11:10:49
*
 */
public class PurchaseHouseParam implements Serializable {
    /***************属性*******************/
